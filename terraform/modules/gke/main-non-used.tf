####### 
# This was the first try, but this for some reason isn't adding network tags to the node pool and hence the firewall rules are not applied, so everything fails. Just keeping here for the record.
#######
...
#     google_service_account.red_pool_service_account
#   ]
# }
